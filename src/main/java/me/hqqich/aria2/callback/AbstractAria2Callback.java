...
import me.hqqich.aria2.exception.Aria2Exception;
...
public abstract class AbstractAria2Callback implements Callback {
	 ...
	 */
	public static ResponseBody body(@NotNull Call call, @NotNull Response response)
			throws Aria2RequestException {
