...
import me.hqqich.aria2.enums.TaskStatus;
import me.hqqich.aria2.response.clazz.Aria2Response;
import me.hqqich.aria2.response.clazz.Aria2ResponseList;
import me.hqqich.aria2.response.clazz.Aria2ResponseMulti;
import me.hqqich.aria2.response.field.Aria2TaskFile;
...
public class Aria2TaskStatus {
	...
	public List<String> getUrls() {
		...
		return files.stream().flatMap(i -> i.getUris().stream()).map(Aria2TaskFile.Uri::getUri)
